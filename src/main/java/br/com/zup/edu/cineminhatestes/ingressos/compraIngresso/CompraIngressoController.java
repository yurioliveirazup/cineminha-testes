...
public class CompraIngressoController {
    ...
    public ResponseEntity<?> compra(@RequestBody @Valid CompraIngressoRequest request) {
        ...
        EmailTemplate emailTemplate = EmailTemplate.destinatario(ingresso.getEmail())
                                            .remetente("nosso.cinema@cinema.com.br")
                                            .assunto("Confirmação de Comrpa")
                                            .corpo("Compra Realizada com sucesso");
