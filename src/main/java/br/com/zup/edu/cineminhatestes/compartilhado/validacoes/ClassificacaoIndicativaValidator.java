...
public class ClassificacaoIndicativaValidator implements ConstraintValidator<ClassificacaoIndicativa, CompraIngressoRequest> {
    ...
    @Override
    public boolean isValid(CompraIngressoRequest request, ConstraintValidatorContext context) {
